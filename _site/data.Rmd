...
datatable(args)
```
<a href="../data/ARG_database.fa" download>
  Download
</a>
<br>
<br>
...
datatable(fprimers)
```
<a href="../data/forward_primers" download>
  Download
</a>
<br>
<br>
...
datatable(rprimers)
```
<a href="../data/reverse_primers" download>
  Download
</a>
<br>
<br>
...
```
<a href="../data/target_ARG_classifications.tsv" download>
  Download
</a>
<br>
<br>
...
```
<a href="../data/mock_strain_infor.csv" download>
  Download
</a>
<br>
<br>
...
mock_genomes
```
<a href="../data/mock_genomes.fa" download>
  Download
</a>
<br>
<br>
...
```
<a href="../data/sample_metadata.csv" download>
  Download
</a>
<br>
<br>
...
```
<a href="../data/read_counts_from_primers.RDS" download>
  Download
</a>
<br>
<br>
