...
#### Soil Column I
```{r sci_counts}
sc_i <- read_counts[ARG != "16S",c(1,2,3,grep('SCI-', colnames(read_counts))), with=FALSE]
```
...
#### Soil Column II
```{r scii_counts}
sc_ii <- read_counts[ARG != "16S",c(1,2,3,grep('SCII', colnames(read_counts))), with=FALSE]
```
...
#### Fecal
```{r fecal_counts}
fecal <- read_counts[ARG != "16S",c(1,2,3,grep('X1P', colnames(read_counts))), with=FALSE]
```
