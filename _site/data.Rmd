...
datatable(args)
```
<a href="https://github.com/schuyler-smith/DARTE-QM/raw/master/data/ARG_database.fa" download target="_blank">
  Download
</a>
<br>
<br>
...
### Primer Details
```{r aprimers, message=FALSE, warning=FALSE, echo=FALSE}
aprimers <- data.table::fread('../data/DARTE-QM_primer_design.csv', header = TRUE)
datatable(aprimers, options = list(
            columnDefs = list(
              list(
                targets = 10,
                render = JS(
...
```
<a href="https://github.com/schuyler-smith/DARTE-QM/raw/master/data/DARTE-QM_primer_design.csv" download target="_blank">
  Download
</a>
<br>
<br>
