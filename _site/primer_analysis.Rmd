...
### Artifact
```{r _artifact_graph, fig.width=12, fig.height=7, echo=FALSE, cache=TRUE}
ggplot(primers, aes_string(x="Primer", y="percent_artifacts")) + 
  geom_bar(stat="identity", position="stack", 
...
### True-Positive
```{r _tp_graph, fig.width=12, fig.height=7, echo=FALSE, cache=TRUE}
ggplot(primers, aes_string(x="Primer", y="percent_artifacts")) + 
  geom_bar(stat="identity", position="stack", 
...
### False-Positive
```{r _fp_graph, fig.width=12, fig.height=7, echo=FALSE, cache=TRUE}
ggplot(primers, aes_string(x="Primer", y="percent_artifacts")) + 
  geom_bar(stat="identity", position="stack", 
...
### False-Negative
```{r _fn_graph, fig.width=12, fig.height=7, echo=FALSE, cache=TRUE}
ggplot(primers, aes_string(x="Primer", y="percent_artifacts")) + 
  geom_bar(stat="identity", position="stack", 
