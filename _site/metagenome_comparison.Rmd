...
graph_data <- melt(read_counts, id.vars = c('ARG_Family', 'ARG', 'Variant', 'Primer'), variable.name = 'Sample_Name')
...
samples <- dcast(compare_data, Sample + Tech + Matrix ~ ARG, 
...
#### Swine Manure-A
DARTE-QM had `r length(unique(compare_data[Tech == 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG))` ARGs in Swine Manure-A samples, with an alpha-diversity measured at `r round(mean(alpha_data[Tech == 'DARTE-QM'][Matrix == "Swine Manure-A"]$Alpha, na.rm = T), 2)`.
<br>

compared to metagenomes which had `r length(unique(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG))` ARGs in Swine Manure-A samples, with an alpha-diversity measured at `r round(mean(alpha_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure-A"]$Alpha, na.rm = T), 2)`.
<br>

The metagenome found `r sum(unique(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG) %in% unique(compare_data[Tech == 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG))` ARGs that were not detected with DARTE-QM.

The mean BC = `r round(mean(as.matrix(vegdist(dcast(compare_data[Matrix == "Swine Manure-A"], Sample + Tech + Matrix ~ ARG_Family, value.var = 'relative_abundance', fun.aggregate = sum)[,-c(1:3)]))[,1]), 2)` for ARG Families in Swine Manure-A Samples between both technologies.

<button class="btn btn-primary" data-toggle="collapse" data-target="#BlockName"> Show Table </button>  
<div id="BlockName" class="collapse"> 
```{r arg_list2, echo=FALSE}
datatable(data.frame(ARG = unique(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG)[unique(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG) %in% 
    unique(compare_data[Tech == 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG)]))
```
</div>
<br>

#### Manure-Soil
DARTE-QM had `r length(unique(compare_data[Tech == 'DARTE-QM'][Matrix != "Swine Manure-A"][relative_abundance > 0]$ARG))` ARGs in Manure-Soil samples, with an alpha-diversity measured at `r round(mean(alpha_data[Tech == 'DARTE-QM'][Matrix != "Swine Manure-A"]$Alpha, na.rm = T), 2)`.
<br>
...
The mean BC = `r round(mean(as.matrix(vegdist(dcast(compare_data[Matrix != "Swine Manure-A"], Sample + Tech + Matrix ~ ARG_Family, value.var = 'relative_abundance', fun.aggregate = sum)[,-c(1:3)]))[,1]),2)` for ARG Families in Manure + Soil-A Samples between both technologies.
...
datatable(data.frame(ARG = sort(as.character(unique(compare_data[Tech != 'DARTE-QM'][Matrix != "Swine Manure-A"][relative_abundance > 0]$ARG)[unique(compare_data[Tech != 'DARTE-QM'][Matrix != "Swine Manure-A"][relative_abundance > 0]$ARG) %in% unique(compare_data[Tech == 'DARTE-QM'][Matrix != "Swine Manure-A"][relative_abundance > 0]$ARG)]))))
```
</div>
...
```{r darte_dist}
darte_manure <- dcast(compare_data[Tech == "DARTE-QM"][Matrix == "Swine Manure-A"], Tech ~ ARG_Family, value.var = 'relative_abundance', fun.aggregate = mean)
darte_soil_manure <- dcast(compare_data[Tech == "DARTE-QM"][Matrix != "Swine Manure-A"], Tech ~ ARG_Family, value.var = 'relative_abundance', fun.aggregate = mean)

meta_manure <- dcast(compare_data[Tech != "DARTE-QM"][Matrix == "Swine Manure-A"], Tech ~ ARG_Family, value.var = 'relative_abundance', fun.aggregate = mean)
meta_soil_manure <- dcast(compare_data[Tech != "DARTE-QM"][Matrix != "Swine Manure-A"], Tech ~ ARG_Family, value.var = 'relative_abundance', fun.aggregate = mean)
```
...
#### Swine Manure-A
With the ARGs filtered to only include those targeted by DARTE-QM, metagenomes found `r length(unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG)))` of the `r length(unique(compare_data[Tech == 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG))` that DARTE-QM found, with an alpha diversity of `r round(mean(alpha_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure-A"]$Alpha, na.rm = T), 2)`. The metagenome technology was able to find `r sum(!(unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG)) %in% unique(as.character(compare_data[Tech == 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG))))` ARGs targeted by DARTE-QM that the DARTE-QM primers were unable to successfully capture.
...
datatable(data.frame(ARG = unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG))[!(unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG)) %in% unique(as.character(compare_data[Tech == 'DARTE-QM'][Matrix == "Swine Manure-A"][relative_abundance > 0]$ARG)))]))
```
</div>
<br>

#### Manunre-Soil
With the ARGs filtered to only include those targeted by DARTE-QM, metagenomes found `r length(unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix != "Swine Manure-A"][relative_abundance > 0]$ARG)))` of the `r length(unique(as.character(compare_data[Tech == 'DARTE-QM'][Matrix != "Swine Manure-A"][relative_abundance > 0]$ARG)))`, with an alpha diversity of `r round(mean(alpha_data[Tech != 'DARTE-QM'][Matrix != "Swine Manure-A"]$Alpha, na.rm = T), 2)`. The metagenome technology was able to find `r sum(!(unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix != "Swine Manure-A"][relative_abundance > 0]$ARG)) %in% unique(as.character(compare_data[Tech == 'DARTE-QM'][Matrix != "Swine Manure-A"][relative_abundance > 0]$ARG))))` ARGs targeted by DARTE-QM that the DARTE-QM primers were unable to successfully capture.
