...
#### Swine Manure
With the ARGs filtered to only include those targeted by DARTE-QM, metagenomes found `r length(unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure"][relative_abundance > 0]$ARG)))` of the `r length(unique(compare_data[Tech == 'DARTE-QM'][Matrix == "Swine Manure"][relative_abundance > 0]$ARG))` that DARTE-QM found, with an alpha diversity of `r round(mean(alpha_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure"]$Alpha, na.rm = T), 2)`. The metagenome technology was able to find `r sum(!(unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure"][relative_abundance > 0]$ARG)) %in% unique(as.character(compare_data[Tech == 'DARTE-QM'][Matrix == "Swine Manure"][relative_abundance > 0]$ARG))))` ARGs targeted by DARTE-QM that the DARTE-QM primers were unable to successfully capture.
...
datatable(data.frame(ARG = unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure"][relative_abundance > 0]$ARG))[!(unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix == "Swine Manure"][relative_abundance > 0]$ARG)) %in% unique(as.character(compare_data[Tech == 'DARTE-QM'][Matrix == "Swine Manure"][relative_abundance > 0]$ARG)))]))
```
</div>
<br>

#### Manunre-Soil
With the ARGs filtered to only include those targeted by DARTE-QM, metagenomes found `r length(unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix != "Swine Manure"][relative_abundance > 0]$ARG)))` of the `r length(unique(as.character(compare_data[Tech == 'DARTE-QM'][Matrix != "Swine Manure"][relative_abundance > 0]$ARG)))`, with an alpha diversity of `r round(mean(alpha_data[Tech != 'DARTE-QM'][Matrix != "Swine Manure"]$Alpha, na.rm = T), 2)`. The metagenome technology was able to find `r sum(!(unique(as.character(compare_data[Tech != 'DARTE-QM'][Matrix != "Swine Manure"][relative_abundance > 0]$ARG)) %in% unique(as.character(compare_data[Tech == 'DARTE-QM'][Matrix != "Swine Manure"][relative_abundance > 0]$ARG))))` ARGs targeted by DARTE-QM that the DARTE-QM primers were unable to successfully capture.
