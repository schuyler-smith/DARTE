...
### Profiles
```{r shotgun, message=FALSE, warning=FALSE}
classification <- 'ARG'
...
### Diversity
```{r apha-div, message=FALSE, warning=FALSE}
index = "shannon"
colors = "default"
alpha <- compare_data
...
```{r div_graph, echo=FALSE, message=FALSE, warning=FALSE, fig.width=5, fig.height=4}
div_graph
```
<br>
<br>
...
### Profiles
```{r compare_targets, message=FALSE, warning=FALSE}
...
### Diversity
```{r apha-div_DARTE_Only, message=FALSE, warning=FALSE, fig.width=5, fig.height=4}
index = "shannon"
colors = "default"
alpha <- compare_data
alpha <- dcast(alpha, ARG ~ Sample, value.var = 'relative_abundance', fun.aggregate = sum)
...
```{r div_graph2, echo=FALSE, message=FALSE, warning=FALSE, fig.width=5, fig.height=4}
div_graph
```
<br>
<br>
