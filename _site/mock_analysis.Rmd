...
setnames(dist_matrix, colnames(dist_matrix)[colnames(dist_matrix) %in% metadata$ID],
         as.character(metadata$Sample[match(colnames(dist_matrix[,-c(1,2)]), metadata$ID)]))
...
graph_data <- melt(spike_counts, id.vars = c('ARG_Family','ARG', 'Variant','Primer'))
