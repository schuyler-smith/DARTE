...
```{r theoretical_pie_out, echo=FALSE}
mock_profile
```
...
```{r primer_counts_out, echo=FALSE, fig.width=12, fig.height=12}
Primer_counts
```
...
```{r ARG_counts_out, echo=FALSE, fig.width=7, fig.height=8}
ARG_counts
```
...
```{r ARG_Family_counts_out, echo=FALSE, fig.width=7, fig.height=8}
ARG_Family_counts
```
...
```{r distances_out, echo=FALSE, fig.width=12, fig.height=7}
dist_matrix_plot
```
